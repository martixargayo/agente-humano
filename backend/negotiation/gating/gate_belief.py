...
from .fingerprints import state_meta_fingerprint, world_buckets_fingerprint
from .shared import interaction_strong_delta_from_diff, _split_world_diff
...
def gate_belief(
    ...
    curr_universal_fp = state_meta_fingerprint((world or {}).get("world_state_meta"))
