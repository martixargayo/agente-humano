...
POLICIES: List[Policy] = [
    ...
    _policy("clarify_missing_info", ["climate", "interests", "options", "adjust", "formalize"], tags={"universal", "recovery_ok"}, plan=PolicyPlan(slots_required=["universal_v2.clarity.missing_info"], max_attempts_per_step=2, max_turns_total=3, no_progress_turns_limit=1, steps=[PolicyStep(kind="ask_open", target_slot="universal_v2.clarity.missing_info", micro_goal="identificar missing info", next_action_hint="Haz 1 pregunta abierta sobre el punto más confuso.", success_if=[SuccessCond(kind="slot_filled", key="universal_v2.clarity.missing_info")]), PolicyStep(kind="ask_targeted", target_slot="universal_v2.clarity.missing_info", micro_goal="concretar datos", next_action_hint="Formula 1–2 preguntas cerradas (sí/no o A/B).", success_if=[SuccessCond(kind="slot_filled", key="universal_v2.clarity.missing_info")])])),
    ...
    _policy("credibility_test_structured", ["adjust"], tags={"adjust", "recovery_ok", "credibility"}, guards={"safe_when_tense", "avoid_mentioning_own_numbers"}, required_inputs=[{"key": "other_buyer_claimed", "op": "true"}], capabilities={"request_evidence", "probe_narrow"}, plan=PolicyPlan(slots_required=["negotiation.other_buyer_text", "negotiation.evidence_offered"], steps=[PolicyStep(kind="request_evidence", target_slot="negotiation.evidence_offered", micro_goal="Pedir evidencia concreta de la oferta.", next_action_hint="Solicita dato verificable (condiciones, timing, prueba).", success_if=[SuccessCond(kind="slot_filled", key="negotiation.evidence_offered")]), PolicyStep(kind="probe_narrow", target_slot="negotiation.other_buyer_text", micro_goal="Aclarar detalles del otro comprador.", next_action_hint="Pregunta por términos, tiempos y condiciones.", success_if=[SuccessCond(kind="slot_filled", key="negotiation.other_buyer_text")])])),
    ...
    _policy("deescalate_tension", ["climate"], tags={"deescalation", "safe_when_tense", "recovery_ok"}, guards={"safe_when_tense", "avoid_mentioning_own_numbers"}, required_inputs=[{"key": "tone_signal", "op": "exists"}], required_beliefs=[{"key": "universal.behavior_guidance.conflict_risk", "op": "gte", "value": 0.6}], capabilities={"pressure_soft", "probe_open"}),
]
