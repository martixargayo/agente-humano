...
def load_conversacion_simple_rubric_v1(domain_context: DomainContext | None = None) -> NegotiationDomainRubricV1:
    assets = resolve_conversacion_simple_evaluation_assets(domain_context)
