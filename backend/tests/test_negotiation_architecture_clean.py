...
def test_trace_meta_non_memory_nodes_do_not_inherit_memory_values(monkeypatch):
    config = flow.build_negotiation_pipeline_config()
    config.model_memory = "model-memory"
    config.model_phase_classifier = "model-phase"
    config.model_planner = "model-planner"
    config.model_executor = "model-executor"
