...
window.EyeTuning = window.EyeTuning || {
  leftCenterX: -0.1948721210457662,
  leftCenterY: 0.4977111561370747,
  leftCenterZ: 0.5856036972143774,
  rightCenterX: 0.08367333970529,
  rightCenterY: 0.5033535072103036,
  rightCenterZ: 0.5020813970586775,
  rx: 0.04189030791809731,
  ry: 0.023515732408208895,
  rz: 0.025,
};

window.IrisTuning = window.IrisTuning || {
  leftCenterX: -0.18568688316744528,
  leftCenterY: 0.4933739402425839,
  leftCenterZ: 0.529167651687906,
  rightCenterX: 0.10209785343086682,
  rightCenterY: 0.49207368547125885,
  rightCenterZ: 0.5529901994218636,
  rx: 0.022,
  ry: 0.016,
  rz: 0.018,
  pupilRx: 0.010,
...
window.BrowTuning = window.BrowTuning || {
  leftCenterX: -0.20381187376700555,
  leftCenterY: 0.5617036951083432,
  leftCenterZ: 0.6289766619013196,
  rightCenterX: 0.11011845876198646,
  rightCenterY: 0.563782350104618,
  rightCenterZ: 0.5831779367086416,
  rx: 0.07323036323544924,
  ry: 0.023228339135275642,
  rz: 0.03126640016299652,
  raiseScale: 0.018,
  furrowScale: 0.012,
};
...
window.PivotTuning = window.PivotTuning || {
  headPivotX: -0.0049661321991437135,
  headPivotY: -0.16454182383794794,
  headPivotZ: 0,
  jawPivotX: -0.08697547883849893,
  jawPivotY: 0.09680858836129912,
  jawPivotZ: 0.02,
  neckPivotX: -0.024336566625178982,
  neckPivotY: -0.43158900454420485,
  neckPivotZ: 0,
  seamY: -0.21375867677594224,
  seamSoftness: 0.08576546936373397,
  neckBand: 0.14435234761770305,
};
